    ...
    def register(
        ...
        try:
            ...
            try:
                ...
                return False, {"error": f"桌面端 Builder ID Token 补抓失败: {desktop_error}"}

            if not self._captured_tokens.get("refreshToken"):
                return False, {"error": "桌面端 Token 交换完成但未返回 refreshToken"}
