...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "label": "LuckMail",
        "description": "LuckMail — recebimento de código de verificação pay-per-success (Modo A)",
        ...
        "fields": [
            ...
            {"key": "luckmail_api_secret", "label": "API Secret", "secret": True, "category": "auth"},
            {"key": "luckmail_project_code", "label": "Project Code", "placeholder": "cursor", "category": "identity"},
            {"key": "luckmail_email_type", "label": "Tipo de Email (opcional)", "placeholder": "ms_graph", "category": "connection"},
            {"key": "luckmail_domain", "label": "Domínio (opcional)", "placeholder": "outlook.com", "category": "connection"},
            {"key": "luckmail_api_url", "label": "API URL (opcional)", "placeholder": "https://mails.luckyous.com", "category": "connection"},
        ],
    },
    {
        "provider_type": "mailbox",
